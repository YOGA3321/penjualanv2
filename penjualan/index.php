...
if (!isset($_SESSION['plg_meja_id'])) {
    ...
    <body>
        <div class="scan-card">
            ...
            <p class="small text-muted mb-4">Atau gunakan kamera bawaan HP Anda.</p>
    ...
    <?php
    exit; // Stop di sini agar menu tidak muncul
}

// --- 3. JIKA SUDAH ADA SESI -> TAMPILKAN MENU ---
