...
<head>
    ...
    <style>
        ...
        .icon-box { color: #fd7e14; font-size: 5rem; margin-bottom: 20px; }
    </style>
</head>
<body>
    <div class="error-card">
        <div class="icon-box"><i class="fas fa-compass"></i></div>
        <h2 class="fw-bold mb-3">Halaman Hilang?</h2>
        <p class="text-muted mb-4">Waduh, halaman yang Anda cari tidak ditemukan. Mungkin linknya rusak atau sudah dihapus.</p>
